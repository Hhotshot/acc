            ...
            <div class="app-header__content">
                <div class="app-header-left">
                    ...
                    <ul class="header-megamenu nav">
                        <li class="nav-item">
                            <a href="javascript:void(0);" data-bs-placement="bottom" rel="popover-focus" data-offset="300" data-toggle="popover-custom" class="nav-link">
                ...
                <div class="app-header-right">
                    <div class="header-dots">
                        ...
                        <div class="dropdown">
                            <button type="button" aria-haspopup="true" data-bs-toggle="dropdown" data-bs-placement="bottom" title="Tooltip on bottom" aria-expanded="false" class="p-0 btn btn-link dd-chart-btn">
                                <span class="icon-wrapper icon-wrapper-alt rounded-circle">
                        ...
                        <div class="main-card mb-3 card">
                            <div class="card-header-tab card-header">
                                <div class="card-header-title font-size-lg text-capitalize fw-normal">
                                    <i class="header-icon lnr-dice me-3 text-muted opacity-6"></i>Easy Dynamic Tables
                                </div>
                                    ...
                                    <div class="col-md-6 col-lg-12">
                                        <div class="card-hover-shadow-2x mb-3 card-btm-border card-shadow-primary border-primary card">
                                            <div class="rm-border pb-0 mt-sm-3 responsive-center card-header">
                                                <div>
                                                    <h5 class="menu-header-title text-capitalize fsize-2 text-muted text-start opacity-6">
                                                        Received Messages
                                                    </h5>
                                                </div>
                                            </div>
                                            <div class="widget-chart widget-chart2 text-start p-0">
                                                <div class="widget-chat-wrapper-outer">
                                                    <div class="widget-chart-content pt-3 pe-3 ps-5">
                                                        <div class="widget-chart-flex">
                                                            <div class="widget-numbers">
                                                                <div class="widget-chart-flex">
                                    ...
                                    <div class="card-body">
                                        <div class="tab-content">
                                            <div class="tab-pane fade active show" id="tab-eg-11">
                                                <div class="card mb-3 widget-chart widget-chart2 text-start p-0">
                                                    <div class="widget-chat-wrapper-outer">
                                                            ...
                                                            <div class="widget-chart-flex">
                                                                <div class="widget-numbers">
                                                                    <div class="widget-chart-flex">
                                                                        ...
                                                                        <div class="widget-title ms-2 opacity-5 font-size-lg text-muted">
                                                                            Total Leads
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                ...
                                                <ul class="rm-list-borders rm-list-borders-scroll list-group list-group-flush">
                                                    <li class="list-group-item">
                                                        <div class="widget-content p-0">
                                                            <div class="widget-content-wrapper">
                                                                <div class="widget-content-left me-3">
                                                                    <img width="42" class="rounded-circle" src="images/avatars/8.jpg" alt="">
                                                                </div>
                                                                <div class="widget-content-left">
                                                                    <div class="widget-heading">Ruben Tillman</div>
                                                                    <div class="widget-subheading">UI Designer</div>
