                    ...
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            <div class="page-title-heading">
                                ...
                                <div>
                                    ข้อมูลตรวจสุขภาพประจำปี
                                    <div class="page-title-subheading">ข้อมูล <?php echo "นายทดสอบ ระบบ"; ?></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-xl-4">
                                <div class="card mb-3 widget-content">
                                    <div class="widget-content-outer">
                                        ...
                                        <div class="widget-progress-wrapper">
                                            <div class="progress-bar-sm progress-bar-animated-alt progress">
                                                <div class="progress-bar bg-success" role="progressbar" aria-valuenow="46" aria-valuemin="0" aria-valuemax="100" style="width: 46%;">
                                                </div>
                                            </div>
                                            <div class="progress-sub-label">
                            ...
                            <div class="d-xl-none d-lg-block col-md-6 col-xl-4">
                                <div class="card mb-3 widget-content">
                                    <div class="widget-content-outer">
                                        ...
                                        <div class="widget-progress-wrapper">
                                            <div class="progress-bar-sm progress-bar-animated-alt progress">
                                                <div class="progress-bar bg-info" role="progressbar" aria-valuenow="54" aria-valuemin="0" aria-valuemax="100" style="width: 54%;">
                                                </div>
                                            </div>
                                            <div class="progress-sub-label">
                        ...
                        <div class="main-card mb-3 card">
                            ...
                            <div class="card-body">
                                <table data-toggle="table" data-sort-name="stargazers_count" data-sort-order="desc">
                                    <?php
                                    $hn = "000010771";
                                    $sql_health = "SELECT * FROM ovst o 
                                    left outer join vn_stat  v  on  o.vn=v.vn
                                    where  o.hn='$hn'";
                                    $re_q = mysqli_query($con_hos, $sql_health);
                                    ?>
                                    <thead align="center">
                                        <tr >
                                    ...
                                    <tbody align="center">
                                        ...
                                        while ($row = mysqli_fetch_assoc($re_q)) {; ?>
                                            <tr>
                                                ...
                                                <td><?= $row['income'] ?></td>
                                                <td><right>
                                                    <button class="mb-2 me-2 btn-icon btn-pill btn btn-outline-info officer_insert" id="<?php echo $row_o['vn'] ?>" data-bs-toggle="modal" data-bs-target=".bd-example-modal-lg">
                                                                  <i class="lnr-heart-pulse"></i>  ดูข้อมูล</button>
                                                    <button class="mb-2 me-2 btn-icon btn-pill btn btn-outline-success officer_insert" id="<?php echo $row_o['vn'] ?>" data-bs-toggle="modal" data-bs-target=".bd-example-modal-lg">
                                                      <i class=" lnr-pencil"></i> บันทึกข้อมูล</button>
                                                    <button class="mb-2 me-2 btn-icon btn-pill btn btn-outline-warning officer_insert" id="<?php echo $row_o['vn'] ?>" data-bs-toggle="modal" data-bs-target=".bd-example-modal-lg">
                                                    <i class="lnr-printer"></i> พิมพ์</button></right>
                                                </td>
                                            <?php  $i++; } ?>
                                            </tr>
                                    </tbody>
