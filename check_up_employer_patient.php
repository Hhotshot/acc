                    ...
                    <div class="app-page-title">
                        <div class="page-title-wrapper">
                            <div class="page-title-heading">
                                ...
                                <div>
                                    ชื่อ-สกุล : <?php
                                                $sql_em  = "SELECT * FROM hpt_check_up where hn='$hn'";
                                                $q_em = mysqli_query($con_hchkup, $sql_em);
                                                $row_em = mysqli_fetch_array($q_em);
                                                if ($hn == " ") {
                                                    echo "ไม่มีข้อมูลนายจ้าง";
                                                }
                                                echo '<font color="red">' . $row_em['ptname'] . '</font>'; ?>
                                    <!-- <div class="page-title-subheading">ชื่อ-สกุล :
                                        <?php
                                        // $sql_em  = "SELECT * FROM hpt_check_up where hn='$hn'";
                                        // $q_em = mysqli_query($con_hchkup, $sql_em);
                                        // $row_em = mysqli_fetch_array($q_em);
                        ...
                        <div class="main-card mb-3 card">
                            ...
                            <div class="card-body">
                                <table style="width: 100%;" id="example" class="table table-hover table-striped table-bordered">
                                    <?php
                                    $sql_health = "SELECT pk.hn,pk.ptname,pk.pttype_name,pk.vstdate,ep.employer_name,pk.vn FROM  hpt_check_up  pk
                                    ...
                                    <tbody>
                                        ...
                                        while ($row = mysqli_fetch_assoc($re_q)) {; ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <center>
                                                        <a href="check_up_appove_doctor.php?vn=<?php echo $row['vn'] ?>"><button class="mb-2 me-2 btn-icon btn-pill btn btn-outline-info officer_insert">
                                                                <i class="lnr-heart-pulse"></i> ดูข้อมูล</button></a>


                                                        <!-- <a href="check_up_appove_doctor.php?vn=<?php echo $row['vn'] ?>"><button class="mb-2 me-2 btn-icon btn-pill btn btn-outline-success officer_insert">
                                                                <i class="lnr-pencil"></i> บันทึกข้อมูล</button></a> -->
