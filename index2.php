                                        ...
                                        <div class="widget-content-outer">
                                            <div class="widget-content-wrapper">
                                                <div class="widget-content-left">
                                                    <div class="widget-heading"><?php echo $r_pttpye['pttype_name'] ?></div>
                                                    <div class="widget-subheading">Last year expenses</div>
                                                </div>
                                                <div class="widget-content-right">
                                                    <div class="widget-numbers text-success"><?php echo number_format($r_pttpye['total_vn']) ?></div>
                                                </div>
                                            </div>
                        ...
                        <div class="main-card mb-3 card">
                            ...
                            <div class="card-body">
                                <table data-toggle="table" data-sort-name="stargazers_count" data-sort-order="desc">
                                    <?php
                                    $hn = "000010771";
                                    $sql_health = "SELECT  ep.id,ep.employer_name,COUNT(DISTINCT(pk.vn))as total_vn FROM  hpt_check_up  pk
                                    left outer join  hpt_employer  ep  on  pk.employer_id=ep.id
                                    GROUP BY pk.employer_id";
                                    ...
                                    <tbody>
                                        ...
                                        while ($row = mysqli_fetch_assoc($re_q)) {; ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <center><?= $row['total_vn'] ?></center>
                                                </td>
                                                <td>
                                                    <center>
                                                        <a href="check_up_employer.php?id=<?php echo $row['id'] ?>"><button class="mb-2 me-2 btn-icon btn-pill btn btn-outline-info officer_insert">
