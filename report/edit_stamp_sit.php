...
$pang_stamp_id = $_REQUEST["pang_stamp_id"];
#$hn = $_GET["hn"];
...
<div style="width:100%;">
    <font style="font-weight: bold;">เรื่อง </font>ขอปรับปรุงแก้ไขยอดลูกหนี้รายงานทางบัญชี ปรับปรุงสิทธิ
</div>
...
<div style="width:100%;">
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;กลุ่มงานประกันสุขภาพฯ ขอนำรายการ HN '.$pang_stamp_hn.' วันที่รับบริการ '.DateThai($pang_stamp_vstdate).' ออกจากผังบัญชี '.$pang_stamp.' ตามเลขที่หนังสือที่ส่ง '.$pang_stamp_send.' ยอดลูกหนี้จำนวน '.number_format($pang_stamp_uc_money,2).' บาท 
</div>
