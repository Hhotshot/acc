...
//$select_sql = " , (uc_money)claim";
$sql = "SELECT * FROM $database_ii.pang_stamp_send WHERE pang_stamp_send='20210602122458' LIMIT 100 ";
...
// สำหรับ Export Eclaim
    ...
    $sub_month = substr($row["pang_stamp_send_date"],5,2);
    $sub_date = substr($row["pang_stamp_send_date"],8,2);
        ...
        <td style="white-space: nowrap;border-right:1px solid #000;text-align:right;"  >'.$row['pang_stamp_send_money'].'</td>
...
<table id="bg-table" width="100%" style="border-collapse: collapse;font-size:12pt;margin-top:8px;">
    <tr style="border:1px solid #000;padding:4px;">
      ...
      <td align="center"  style="border-right:1px solid #000;padding:4px;text-align:center;" width="auto"> จำนวนลูกหนี้ </td>
...
$end .="<div style='float:left;left: auto;width: 33%;border: 0px solid blue;text-align: center;'><BR>ลงชื่อ__________________________ <BR> (".$r_data["data_hos_claim"].") <BR> ".$r_data["data_hos_claim_position"]." <BR> วันที่_____/_____________/______ </div>";

$end .="<div style='float:left;left: auto;width: 33%;border: 0px solid blue;text-align: center;'><BR>ลงชื่อ__________________________ <BR> (".$r_data["data_hos_money"].") <BR> ".$r_data["data_hos_money_position"]." <BR> วันที่_____/_____________/______ </div>";

$end .="<div style='float:left;right: 0%;width: 33%;border: 0px solid green;text-align: center;'><BR>ลงชื่อ__________________________ <BR> (".$r_data["data_hos_director"].") <BR> ".$r_data["data_hos_director_position"]." <BR> วันที่_____/_____________/______ </div>";
$end .="</div>";
$mpdf->AddPage('L');
